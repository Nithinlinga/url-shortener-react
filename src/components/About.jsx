...
const AboutPage = () => {
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-8 bg-[#0a0a0a] text-white">
      <div className="w-full max-w-5xl mx-auto">
        <h1 className="sm:text-4xl text-3xl font-bold italic mb-4 tracking-tight">
          About LinkNShare
        </h1>
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-start space-x-4">
            <FaLink className="text-blue-500 text-2xl mt-1" />
            <div>
              <h2 className="text-xl font-semibold">Simple URL Shortening</h2>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h2 className="text-xl font-semibold">Powerful Analytics</h2>
              <p className="text-gray-400">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h2 className="text-xl font-semibold">Enhanced Security</h2>
              <p className="text-gray-400">
